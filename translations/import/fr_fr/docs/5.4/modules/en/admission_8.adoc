...
* Configuration de limite de ressources (RLC). Exige que des limites de ressources soient configurées pour la limite/demande de CPU, la limite/demande de mémoire, et peut exiger que l'opérateur soit > ou \<= une valeur de ressource configurée. 
