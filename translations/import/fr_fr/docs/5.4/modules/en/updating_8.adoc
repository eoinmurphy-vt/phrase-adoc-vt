...
Pour les utilisateurs de Helm, mettez à jour vers {product-name} le chart Helm 2.0.0 ou ultérieur (avant {product-name} 5.2.0). Si vous mettez à jour un installateur ou une installation Helm sur OpenShift, consultez la note ci-dessous.
