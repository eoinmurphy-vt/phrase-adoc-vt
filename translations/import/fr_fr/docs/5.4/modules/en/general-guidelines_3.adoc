...
Veuillez consulter la première section Bases -> Connexion au gestionnaire pour les options permettant de désactiver https ou d'accéder à la console via un pare-feu d'entreprise qui n'autorise pas le port 8443 pour l'accès à la console.
