...
* Variables d'environnement avec secrets. Si le yaml de déploiement ou le résultat du scan d'image contient (ou ne contient pas) des variables d'environnement avec des secrets. Voir les critères pour les secrets correspondants ci-dessous. 
