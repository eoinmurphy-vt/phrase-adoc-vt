...
Les vérificateurs configurés qu'une image satisfait peuvent être consultés dans la section supérieure droite des résultats d'analyse d'une image donnée dans Actifs->Registres. Si une image n'est pas signée par un vérificateur, elle n'apparaîtra pas dans ses résultats de scan.
