...
+
Si vous pouvez voir le secret, mais ne pouvez pas trouver ces secrets, envisagez d'activer `+internal.autoRotateCert+` dans le remplacement des graphiques helm. Cette option générera et fera tourner votre certificat interne automatiquement.
+
