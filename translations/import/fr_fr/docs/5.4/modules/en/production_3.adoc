...
Les sauvegardes de ConfigMaps et de stockage persistant ne sont lues que lorsqu'un nouveau cluster {product-name} est déployé, ou lorsque le cluster échoue et redémarre. Elles ne sont pas utilisées lors des mises à jour progressives.
...
== Architecture multi-site, multi-cluster
