...
. La signature de réponse ADFS SamlResponseSignature doit être soit MessageOnly soit MessageAndAssertion.  Utilisez la commande Get-AdfsRelyingPartyTrust pour vérifier ou mettre à jour cela.
+
image:nv_adfs2.png[adfsTroubleshooting]

. Synchronisation du temps entre les nœuds Kubernetes et le serveur ADFS
