...
Les résultats de scan de tous les scanners sont affichés dans le menu Actifs -> Registries. Des fonctionnalités de surveillance supplémentaires des scanners seront ajoutées dans de futures versions.
