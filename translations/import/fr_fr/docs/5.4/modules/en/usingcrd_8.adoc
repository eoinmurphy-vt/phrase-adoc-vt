...
[NOTE]
====
Les CRDs sont prises en charge dans Kubernetes 1.11 et versions ultérieures. Le déploiement de la règle de sécurité CRD {product-name} dans des versions antérieures peut ne pas entraîner d'erreur, mais la CRD ne sera pas traitée.
====
