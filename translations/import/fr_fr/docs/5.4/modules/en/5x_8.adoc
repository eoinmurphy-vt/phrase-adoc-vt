...
* Première version d'une version 'tech-preview' non prise en charge de {product-name} version open source 5.0.
...
* Le chart Helm v1.8.9 est publié pour les déploiements 5.0.0. Si vous utilisez cela avec la version de prévisualisation de 5.0.0, les modifications suivantes doivent être apportées à values.yml :
