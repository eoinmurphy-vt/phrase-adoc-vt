...
[IMPORTANT]
====
Les versions d'opérateur {product-name} sont liées aux versions de produit {product-name}, et chaque nouvelle version de produit doit passer par un processus de certification avec Red Hat avant d'être publiée.
====
