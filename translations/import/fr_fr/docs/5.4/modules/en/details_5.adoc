...
+
____
(Optionnel) Port LAN Serf du cluster. Les ports TCP et UDP doivent être mappés directement à l'hôte. Optionnel s'il n'y a pas de conflit de port sur l'hôte. Par défaut `+18301+`
____
