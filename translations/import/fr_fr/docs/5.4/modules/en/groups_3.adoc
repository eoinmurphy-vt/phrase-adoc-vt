...
+
____
Sélectionnez des conteneurs par leurs services. Si un conteneur est déployé par Docker Compose, sa valeur de tag de service sera "project_name:service_name" ; si un conteneur est déployé par le service de mode swarm Docker, sa valeur de tag de service sera le nom du service swarm.
____
