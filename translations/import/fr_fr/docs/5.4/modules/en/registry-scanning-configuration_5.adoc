...
Exemple montrant le résultat de l'analyse de couche d'une image, qui montre les vulnérabilités de chaque couche, la taille de la couche et les commandes exécutées sur chaque couche. De plus, il y a un onglet Conformité qui montre les résultats des tests de conformité pour l'image.
