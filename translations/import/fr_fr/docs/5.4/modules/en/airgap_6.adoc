...
:page-opendocs-slug: /déploiement/isolation_air
...
Vous devriez maintenant voir un fichier comme `+core-2.4.0.tgz+`. La version peut varier, mais c'est correct. Ceci est le graphique téléchargé. Maintenant, nous avons besoin des images. Heureusement, nous pouvons utiliser le graphique pour résoudre cela.
