...
== Activation des navigateurs Chrome pour accepter le certificat auto-signé {product-name} sur MacOS
...
Ci-dessous se trouve une capture d'écran qui permet à l'utilisateur de passer à la page de connexion {product-name} après que le lien Procéder à ... (non sécurisé) ait été cliqué.
