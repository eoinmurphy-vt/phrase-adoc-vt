...
Le point clé ici est d'illustrer qu'en utilisant Rolebinding, cela aura une portée au niveau de l'espace de noms, tandis qu'en utilisant Clusterrolebinding, cela aura une portée au niveau du cluster.  User1 sera Rolebind (portée au niveau de l'espace de noms), et User2 sera Clusterrolebind (portée au niveau du cluster).  Cela est particulièrement important lors de l'application de RBAC en fonction du niveau de portée qui limite l'accès des utilisateurs créés.
