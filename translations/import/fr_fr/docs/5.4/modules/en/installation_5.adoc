...
Déployez les conteneurs {product-name} en utilisant Kubernetes, OpenShift, Rancher, Docker ou d'autres plateformes. Chaque type de conteneur {product-name} a un but unique et peut nécessiter des performances spéciales ou des exigences de sélection de nœuds pour un fonctionnement optimal.
