...
Dans la page d'intégration de votre application, accédez à l'onglet &quot;`+Assignments+`&quot; et assurez-vous que vous avez les affectations correspondantes répertoriées :
