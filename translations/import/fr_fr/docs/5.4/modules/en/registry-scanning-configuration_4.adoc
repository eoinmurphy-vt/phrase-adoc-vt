...
** La numérisation automatique n'est prise en charge qu'avec l'intégration d'imagestream OpenShift. Un lien de rôle approprié doit être configuré à l'avance.
