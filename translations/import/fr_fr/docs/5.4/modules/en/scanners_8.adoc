...
Expérimentez avec des nombres variés de scanners sur des registres avec un grand nombre d'images pour observer le comportement du temps d'achèvement du scan dans votre environnement. 2-5 scanners comme paramètre de réplique devraient suffire dans la plupart des cas.
