...
Für Informationen zur Automatisierung der Föderation über ConfigMap sehen Sie sich die Dokumentation zu xref:configmap.adoc#_federated_configmap_examples_fedinitcfg_yaml[Föderierte ConfigMap-Beispiele] an.
