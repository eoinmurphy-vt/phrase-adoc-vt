...
Die folgende Tabelle zeigt die durchschnittliche Latenz von 2-10%, die mit dem Redis-Benchmark-Tool bewertet wurde. Der Redis-Benchmark verwendet ziemlich kleine Pakete, daher wird erwartet, dass die Latenz bei größeren Paketen niedriger ist.
