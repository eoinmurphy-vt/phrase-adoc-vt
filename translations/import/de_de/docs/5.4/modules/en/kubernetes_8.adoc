...
[NOTE]
====
PKS ist feldgetestet und erfordert die Aktivierung privilegierter Container im Plan/Fliese und die Änderung des YAML hostPath wie folgt für All-in-One, Durchsetzungsmechanismus:
