...
--
. Wählen Sie &quot;`+Add Rule...+`&quot; aus und wählen Sie &quot;`+Transform an Incoming Claim+`&quot;; wählen Sie dann &quot;`+Next+`&quot; aus.  Benennen Sie die Regel und setzen Sie das Feld wie im Screenshot unten fest.  Das ausgehende Namens-ID-Format muss Transient Identifier sein.
+
