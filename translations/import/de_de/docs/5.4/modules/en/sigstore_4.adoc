...
Zuerst konfigurieren Sie eine Vertrauensbasis. Dies kann entweder eine öffentliche oder private Vertrauensbasis sein, abhängig von der Sigstore-Implementierung, die zur Erstellung von Signaturen verwendet wird. Wenn Sie Ihre eigenen Instanzen der Sigstore-Dienste bereitgestellt haben, wählen Sie die Option für die private Vertrauensbasis.
