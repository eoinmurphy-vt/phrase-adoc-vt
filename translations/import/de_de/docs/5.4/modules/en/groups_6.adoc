...
Platzhalter '_' können in Kriterien verwendet werden, zum Beispiel 'address=_.google.com'. Für flexiblere Übereinstimmungen verwenden Sie die Tilde '~', um anzuzeigen, dass ein Regex-Match gewünscht ist. Zum Beispiel, um Labels 'policy~public.*-ext1' für das Label policy abzugleichen.
