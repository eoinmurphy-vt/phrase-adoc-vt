...
{product-name} enthält standardmäßige selbstsignierte Zertifikate zur Verschlüsselung für die Verwaltung (Konsole/UI-Zugriff), Controller (REST-API, intern), Enforcer (intern) und Scanner (intern) Kommunikation.
...
----
+
* Mischen Sie die alten und neuen `+ca.crt+` Dateien 
+
[source,bash]
----
