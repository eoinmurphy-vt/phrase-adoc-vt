...
[NOTE]
====
Wenn das --node-selector Argument beim Erstellen eines Projekts verwendet wird, wird dies die Platzierung von Pods wie für den {product-name} Durchsetzer auf bestimmte Knoten beschränken.
====
