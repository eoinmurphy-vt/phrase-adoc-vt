...
Zeigt vordefinierte Datei-Zugriffsregeln für den Dienst node-pod.demo-nvqa an. Dies kann für diesen Dienst angezeigt werden, indem Sie auf das Informationssymbol &quot;`+show predefined filters+`&quot; in der rechten Ecke des Tabs für die Datei-Zugriffsregel klicken.
