...
Gelernt Gruppen (nicht reservierte oder benutzerdefinierte Gruppen) können automatisch von {product-name} gelöscht werden, wenn keine Mitglieder (Container) in der Gruppe vorhanden sind. Der Zeitraum dafür ist in den Einstellungen -> Konfiguration konfigurierbar.
