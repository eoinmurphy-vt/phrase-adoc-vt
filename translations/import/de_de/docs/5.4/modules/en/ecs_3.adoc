...
Der Referenzabschnitt unten wird nicht mehr gepflegt. Er kann jedoch einige Hilfestellungen bieten, um zu verstehen, wie man das Allinone auf ECS bereitstellt.
...
--
. Jetzt können Sie den All-in-One-Dienst bereitstellen. Setzen Sie die &quot;`+Number of tasks+`&quot; auf die gewünschte Anzahl von All-in-One/Controller. Jetzt werden die {product-name} All-in-One- oder Controller-Container auf den ausgewählten Knoten ausgeführt. Nachdem der All-in-One gestartet wurde, sollten Sie in der Lage sein, über HTTPS auf die {product-name} Konsole auf Port 8443 zuzugreifen.
