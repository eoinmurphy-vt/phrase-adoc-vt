...
Um alle Bilder zu erhalten, verwenden wir das Chart selbst. Mit https://helm.sh/[Helm] fügen wir das Repo hinzu und laden das Chart herunter. Wir werden auch https://github.com/containers/skopeo[skopeo] zum Herunterladen und Hochladen verwenden.
...
Sie sollten jetzt eine Datei wie `+core-2.4.0.tgz+` sehen. Die Version kann variieren, aber das ist korrekt. Dies ist das heruntergeladene Chart. Jetzt brauchen wir die Bilder. Gut, dass wir das Chart verwenden können, um das herauszufinden.
