...
* CVE-Wertung. Konfigurieren Sie sowohl die Mindestbewertung als auch die Anzahl der CVEs, die die Mindest-CVSS-Bewertung erfüllen oder überschreiten. 
