...
Nachdem Sie die {product-name} Komponenten bereitgestellt haben, können Sie diese mit den von uns bereitgestellten Beispiel-Testanwendungen bewerten. Diese befinden sich im `+'nvbeta+`' Repository auf Docker Hub.
...
Wenn der obige Link nicht funktioniert, können Sie http://neuvector.com/sample-applications-test-plan/[es von unserer Website] mit dem Passwort nv1851blvd herunterladen.
