...
== Test_FiveDetailed Configuration for the Jenkins Plugin
...
=== Test_FiveGlobal Configuration in Jenkins
...
=== Test_FiveLocal Configuration for scanning a remote Docker Host

==== Test_FivePrerequisites for Local Scan on a Remote Docker Host
...
=== Test_FiveSetting Up the Pipeline to Build Large Scale Parallel Scans
...
== Test_FiveOpenShift Route and Registry Token Example
...
== Test_FiveSpecial Use Case for Jenkins in the Same Kubernetes Cluster
