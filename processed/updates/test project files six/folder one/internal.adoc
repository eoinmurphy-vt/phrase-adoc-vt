= Test_SixReplacing Internal Certificates
:revdate: 2025-01-27
...
== Test_SixInternal Communication and Certificates
...
=== Test_SixReplacing Certificates Used in Internal Communications of {product-name}
...
=== Test_SixUpdating/Deploying with Helm
