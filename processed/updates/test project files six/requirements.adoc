...
Example - largest image size = Test_Six1.3GB, the scanner container memory should be 1.8GB
...
== Test_SixPerformance and Scaling
...
=== Test_SixAdding Scaling Constraints for Large Workload Environments
