...
== Test_EightDetailed Configuration for the Jenkins Plugin
...
=== Test_EightGlobal Configuration in Jenkins
...
=== Test_EightLocal Configuration for scanning a remote Docker Host

==== Test_EightPrerequisites for Local Scan on a Remote Docker Host
...
=== Test_EightProject Configuration
...
=== Test_EightSetting Up the Pipeline to Build Large Scale Parallel Scans
...
== Test_EightOpenShift Route and Registry Token Example
...
== Test_EightSpecial Use Case for Jenkins in the Same Kubernetes Cluster
