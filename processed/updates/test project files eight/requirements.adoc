...
Example - largest image size = Test_Eight1.3GB, the scanner container memory should be 1.8GB
...
== Test_EightPerformance and Scaling
...
=== Test_EightAdding Scaling Constraints for Large Workload Environments
