= Test project seventeen Replacing Internal Certificates
:revdate: 2025-01-27
...
== Test_TwoInternal Communication and Certificates
...
=== Test_TwoReplacing Certificates Used in Internal Communications of {product-name}
...
=== Test_TwoUpdating/Deploying with Helm
