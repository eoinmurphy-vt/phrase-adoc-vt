= Test Integrations & Other Components
:revdate: 2024-09-27
:page-revdate: {revdate}
:page-opendocs-origin: /14.releasenotes/02.other/02.other.md
:page-opendocs-slug:  /releasenotes/other

== Test Release Notes for Integration Modules, Plug-Ins, Other Components
...
=== Test Community Operator v1.2.7 for Helm Chart 1.8.2
...
=== Test Certified Operator v1.2.8 for {product-name} v4.3.1
...
=== Test Helm Chart update 1.8.0 July 2021
...
=== Test Other Integrations July 2021
...
=== Test Helm Chart update 1.7.5 May 2021
...
=== Test Operator Updates April 2021
...
=== Test Jenkins Plug-In v1.12 March 2021
...
=== Test Update Helm Chart to 1.7.1 March 2021
...
=== Test Jenkins Plug-In v1.11 February 2021
...
=== Test Important Helm Chart Update November 2020
