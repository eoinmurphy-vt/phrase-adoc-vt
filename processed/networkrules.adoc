...
== Test_TwoEgress Control: Allowing Connections to Trusted Internal Services on Other Networks
...
=== Test_TwoIngress IP Policy Based on X-FORWARDED-FOR
...
=== Test_TwoSpecial Enforcement for Istio ServiceEntry Destinations
...
== Test_TwoSplit Mode Network Protections
...
== Test_TwoBuilt-In Network Threat Detection
