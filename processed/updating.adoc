...
== Test Updating {product-name} Components
...
== Test Updating the Vulnerability CVE Database
...
== Test Upgrading from {product-name} 4.x to 5.1.x
...
=== Test Note about SCC and Upgrading via Operator/Helm
