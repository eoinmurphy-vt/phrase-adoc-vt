= Test_TwoDLP & WAF Sensors
:revdate: 2025-05-05
:page-revdate: {revdate}
:page-opendocs-origin: /05.policy/09.dlp/09.dlp.md
:page-opendocs-slug:  /policy/dlp

== Test_TwoData Loss Prevention (DLP) and Web Application Firewall (WAF)
...
=== Test_TwoConfiguring DLP and WAF sensors
...
=== Test_TwoConfiguring Federated DLP and WAF Sensors
...
=== Test_TwoApplying DLP/WAF Sensors to Container Groups
...
==== Test_TwoDLP/WAF Behavior Summary
...
=== Test_TwoDLP/WAF Actions in Discover, Monitor, Protect Modes
...
=== Test_TwoLog4j Detection WAF Pattern
...
=== Test_TwoTesting the Log4j WAF Detection
...
==== Test_TwoDLP match in Discover or Monitor Mode

image:dlp4_alert_discover.png[DLPAlert]

==== Test_TwoDLP match in Protect Mode

image:dlp_5_protect.png[DLPProtect]

==== Test_TwoDLP Security Event Notification for Credit Card Match
...
== Test_TwoManaging WAF Rules Using Import/Export or CRDs
