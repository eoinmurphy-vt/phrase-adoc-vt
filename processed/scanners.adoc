= Test_ThreeParallel & Standalone Scanners
:revdate: 2024-09-27
:page-revdate: {revdate}
:page-opendocs-origin: /06.scanning/06.scanners/06.scanners.md
:page-opendocs-slug:  /scanning/scanners

== Test_ThreeIncrease Scanner Scalability with Multiple Scanners
...
=== Test_ThreeAuto-scaling of Scanner Pods
...
=== Test_ThreeOperations and Debugging
...
== Test_ThreeStandalone Scanner for Local Scanning
...
* SCANNER_REGISTRY= Test_Threeurl of the registry (optional instead of local scan)
* SCANNER_REPOSITORY= Test_Threerepository to scan
* SCANNER_TAG= Test_Threeversion tag
* SCANNER_REGISTRY_USERNAME= Test_Threeuser (optional instead of local scan)
* SCANNER_REGISTRY_PASSWORD= Test_Threepassword (optional instead of local scan)
* SCANNER_SCAN_LAYERS= Test_Threetrue or false (to return layered scan results)
...
=== Test_ThreeHost Scanning in Standalone Mode
...
=== Test_ThreeManual Deployment of Multiple Scanners on Kubernetes
