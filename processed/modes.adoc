= Test_ThreeModes: Discover, Monitor, Protect
:revdate: 2024-09-27
...
== Test_ThreeSwitching Between Modes
...
=== Test_ThreeNetwork Service Policy Mode
...
=== Test_ThreeAutomated Promotion of Group Modes
...
==== Test_ThreeConflict Resolution Between Services In Different Modes
