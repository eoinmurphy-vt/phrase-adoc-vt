...
=== Test_ThreeBasic File Protections
...
=== Test_ThreeBehavioral-learning based Allowed Applications in Discover Mode
...
=== Test_ThreeCreating Custom File/Directory Monitoring Rules
...
=== Test_ThreeFile access rule order precedence
