...
=== Test_TwoZero-drift File Protection
...
=== Test_TwoBasic File Protections
...
=== Test_TwoBehavioral-learning based Allowed Applications in Discover Mode
...
=== Test_TwoCreating Custom File/Directory Monitoring Rules
...
=== Test_TwoFile access rule order precedence
...
== Test_TwoSplit Mode File Protections
