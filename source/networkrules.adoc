...
== Test_ThreePolicy: Network Rules
...
== Test_ThreeEgress Control: Allowing Connections to Trusted Internal Services on Other Networks
...
=== Test_ThreeIngress IP Policy Based on X-FORWARDED-FOR
...
=== Test_ThreeSpecial Enforcement for Istio ServiceEntry Destinations
...
=== Test_ThreeVirtual Host Based Network Policy
...
== Test_ThreeBuilt-In Network Threat Detection
