...
== Test Configuring the Primary and Remote Clusters
...
=== Test Verify fed-master service
...
=== Test Verify fed-managed service
...
=== Test Federating Results from CI/CD Scanners (Optional)
