= Test_TwoNavigating the Console
:revdate: 2024-09-27
...
===== Test_TwoX-FORWARDED-FOR Behavior Details
...
==== Test_TwoSettings -> LDAP/AD, SAML, and OpenID Connect
...
=== Test_TwoIcon Descriptions in Legend > Network Activity
...
==== Test_TwoGroup/Container/Service Mesh in discovery
...
==== Test_TwoGroup/Container/Service Mesh being monitored

This container is in Monitor mode, where violations will be logged but not blocked.

==== Test_TwoGroup/Container/Service Mesh being protected
