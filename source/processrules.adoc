...
=== Test_TwoZero-drift Process Protection
...
=== Test_TwoBasic Mode Process Protection
...
=== Test_TwoBehavioral Learning Based Process Protection
...
=== Test_TwoProcess Rules for Nodes
...
=== Test_TwoProcess Rules for Custom Groups
...
=== Test_TwoMonitor/Protect mode (new container started in monitor or protect mode)
...
=== Test_TwoCreating process profile rules
...
=== Test_TwoBuilt-in Suspicious Process Detection
...
== Test_TwoSplit Mode Process/File Protections
