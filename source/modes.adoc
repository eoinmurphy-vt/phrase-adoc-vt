= Test_TwoModes: Discover, Monitor, Protect
:revdate: 2024-09-27
...
== Test_TwoSwitching Between Modes
...
=== Test_TwoNetwork Service Policy Mode
...
=== Test_TwoAutomated Promotion of Group Modes
...
==== Test_TwoConflict Resolution Between Services In Different Modes
