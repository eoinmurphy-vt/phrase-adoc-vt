...
== Test_TwoDetailed Configuration for the Jenkins Plugin
...
=== Test_TwoGlobal Configuration in Jenkins
...
=== Test_TwoLocal Configuration for scanning a remote Docker Host

==== Test_TwoPrerequisites for Local Scan on a Remote Docker Host
...
=== Test_TwoSetting Up the Pipeline to Build Large Scale Parallel Scans
...
== Test_TwoOpenShift Route and Registry Token Example
...
== Test_TwoSpecial Use Case for Jenkins in the Same Kubernetes Cluster
