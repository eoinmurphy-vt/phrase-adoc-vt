= Test_EightParallel & Standalone Scanners
:revdate: 2024-09-27
:page-revdate: {revdate}
:page-opendocs-origin: /06.scanning/06.scanners/06.scanners.md
:page-opendocs-slug:  /scanning/scanners

== Test_EightIncrease Scanner Scalability with Multiple Scanners
...
=== Test_EightAuto-scaling of Scanner Pods
...
=== Test_EightOperations and Debugging
...
== Test_EightStandalone Scanner for Local Scanning
...
* SCANNER_REGISTRY= Test_Eighturl of the registry (optional instead of local scan)
* SCANNER_REPOSITORY= Test_Eightrepository to scan
* SCANNER_TAG= Test_Eightversion tag
* SCANNER_REGISTRY_USERNAME= Test_Eightuser (optional instead of local scan)
* SCANNER_REGISTRY_PASSWORD= Test_Eightpassword (optional instead of local scan)
* SCANNER_SCAN_LAYERS= Test_Eighttrue or false (to return layered scan results)
...
=== Test_EightHost Scanning in Standalone Mode
...
=== Test_EightManual Deployment of Multiple Scanners on Kubernetes
