...
[NOTE]
====
Wenn Sie mit dem Rancher Manager 2.6.5+ {product-name} Chart bereitstellen, werden die Bilder automatisch aus dem Rancher Registry gespiegelt, und die Bereitstellung erfolgt im Namespace cattle-neuvector-system.
====
...
[NOTE]
====
PKS ist feldgetestet und erfordert die Aktivierung privilegierter Container für den Plan/das Tile und die Änderung des YAML hostPath wie folgt für All-in-One, Durchsetzer:
