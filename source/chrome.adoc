= Test Chrome Certificate Upload - MacOS
:revdate: 2024-09-27
...
== Test Enabling Chrome Browsers to Accept the {product-name} Self-Signed Certificate on MacOS
...
=== Test Certificate export using Chrome
...
=== Test Certificate export using macOS Keychain-Access
...
=== Test Launching the macOS Keychain-Access Application
...
=== Test Launching Keychain-Access from the Chrome Browser
...
=== Test Certificate import into the macOS Keychain-Access Store
...
=== Test Enabling trust for the {product-name} Certificate
