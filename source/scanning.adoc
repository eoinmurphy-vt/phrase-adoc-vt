...
== Test Overview of {product-name} Scanning
...
== Test Managing Vulnerabilities and Compliance
...
=== Test Automated Run-Time Scanning
...
== Test Automated Actions, Mitigations, and Responses Based on Vulnerabilities
...
=== Test Federated Registries for Distributed Image Scanning Results
