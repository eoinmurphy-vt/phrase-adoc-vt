= Tester le projet dix-sept API REST et automatisation
:revdate: 2025-05-08
...
N'oubliez pas d'arrêter la session de sniffing après un certain temps pour qu'elle ne fonctionne pas indéfiniment. Le nombre de fichiers à faire tourner a une valeur maximale de 50.
