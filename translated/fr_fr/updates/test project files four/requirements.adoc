...
Exemple - taille d'image la plus grande = Test_Five1,3 Go, la mémoire du conteneur du scanner doit être de 1,8 Go.
...
== Test_FivePlateformes prises en charge
...
== Test_CinqPerformance et Scalabilité
...
=== Test_CinqAjout de contraintes de mise à l'échelle pour des environnements de charge de travail importants
