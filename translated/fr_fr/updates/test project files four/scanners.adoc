= Test_CinqScanners parallèles et autonomes
:revdate: 2024-09-27
:page-revdate: {revdate}
:page-opendocs-origin: /06.scanning/06.scanners/06.scanners.md
:page-opendocs-slug:  /scanning/scanners

== Test_CinqAugmenter l'évolutivité des scanners avec plusieurs scanners
...
=== Test_CinqMise à l'échelle automatique des pods de scanner
...
=== Test_CinqOpérations et Débogage
...
== Test_CinqPlanification de Performance
...
== Test_FiveStandalone Scanner pour le scan local
...
* SCANNER_REGISTRY= Test_Fiveurl du registre (optionnel au lieu du scan local)
* SCANNER_REPOSITORY= Test_Fiverepository à scanner
* SCANNER_TAG= Test_Fiveversion tag
* SCANNER_REGISTRY_USERNAME= Test_Fiveutilisateur (optionnel au lieu du scan local)
* SCANNER_REGISTRY_PASSWORD= Test_Fivepassword (optionnel au lieu du scan local)
* SCANNER_SCAN_LAYERS= Test_Fivetrue ou false (pour retourner les résultats de scan en couches)
...
=== Test_FiveHost Analyse en mode autonome
...
=== Test_FiveDéploiement manuel de plusieurs scanners sur Kubernetes
