= Test projet seize Remplacement des certificats internes
:revdate: 2025-01-27
...
{product-name} inclut des certificats auto-signés par défaut pour le chiffrement pour le Manager (accès console/UI), le Contrôleur (API REST, interne), l'Enforcer (interne) et les communications Scanner (interne).
