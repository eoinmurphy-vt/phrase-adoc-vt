= Test_TwoAPI REST et automatisation
:revdate: 2025-05-08
...
[IMPORTANT]
====
Si vous effectuez des appels d'API REST avec un nom d'utilisateur/mot de passe, veuillez vous assurer de faire un appel DELETE contre /v1/auth une fois terminé. Il y a un maximum de 32 sessions simultanées pour chaque utilisateur. Si cela est dépassé, un échec d'authentification se produira.
====
...
Accepter le contrat de licence utilisateur final (EULA)
...
Vérifiez à nouveau le contrat de licence utilisateur final (EULA).
