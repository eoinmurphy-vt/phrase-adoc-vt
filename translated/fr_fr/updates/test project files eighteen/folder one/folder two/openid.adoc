...
== Test_DouzeIntégration avec OpenID Connect (OIDC) pour Azure et Okta
...
Localisez l'URI de redirection OpenID Connect en haut de la page des paramètres OpenID Connect {product-name}. Vous devrez copier cette URI dans les *URI de redirection de connexion* pour Okta et *URL de réponse* pour Microsoft Azure.
...
Allez à votre {product-name} console et naviguez vers &quot;+`+Paramètres+`+&quot; -> &quot;+`+Paramètres OpenId Connect+`+&quot;.  En haut de la page, à côté de &quot;+`+URI de redirection OpenID Connect+`+&quot; étiquette cliquez sur &quot;+`+Copier dans le presse-papiers+`+&quot;.
...
Changez l'émetteur de &quot;+`+Dynamic (based on request domain)+`+&quot; à l'&quot;+`+Okta URL+`+&quot; fixe :
