...
Dans la section &quot;`+Client Credentials+`&quot;, cliquez sur modifier et modifiez la section &quot;`+Client Authentication+`&quot; de &quot;`+Use PKCE (for public clients)+`&quot; à &quot;`+Use Client Authentication+`&quot;, puis cliquez sur sauvegarder. Cela générera automatiquement un nouveau secret dont nous aurons besoin dans les prochaines étapes de configuration {product-name} :
