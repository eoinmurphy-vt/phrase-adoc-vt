= Test projet quatorze Remplacement des certificats internes
:revdate: 2025-01-27
...
[IMPORTANT]
====
Les versions NeuVector 5.4.2 et ultérieures doivent avoir des utilisateurs générer/remplacer des certificats internes avant d'utiliser NeuVector.
Après mars 2025, les versions NeuVector antérieures à 5.4.2 doivent avoir des utilisateurs générer/remplacer des certificats internes avant d'utiliser NeuVector.
====
