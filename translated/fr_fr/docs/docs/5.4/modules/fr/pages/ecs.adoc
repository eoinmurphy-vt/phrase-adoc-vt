...
. Définissez un attribut pour les nœuds sur lesquels vous souhaitez déployer {product-name} All-in-One ou le conteneur de contrôleur. Par exemple, si vous souhaitez exécuter {product-name} en mode contrôleur HA, il est recommandé de sélectionner au moins 3 nœuds et d'ajouter l'attribut sur les 3 nœuds.
+
--
...
. Créez une nouvelle révision de la tâche All-in-One/Contrôleur, mettez à jour "\`+CLUSTER_JOIN_ADDR\+`" avec l'adresse IP du nœud privé du 2. All-in-One/Contrôleurs.
