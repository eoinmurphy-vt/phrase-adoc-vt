...
Tous les conteneurs {product-name} sont maintenant mis à jour en direct. Toutes les politiques, journaux et configurations ne sont pas affectés. La vue du diagramme en direct sera automatiquement régénérée dès qu'un nouveau trafic en direct circule entre les conteneurs.
