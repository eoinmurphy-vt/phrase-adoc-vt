...
[NOTE]
====
PKS est testé sur le terrain et nécessite d'activer les conteneurs privilégiés pour le plan/tuile, et de modifier le hostPath yaml comme suit pour Allinone, Enforcer :
