...
* Mettre à jour les noms/tags d'image vers la version actuelle sur Docker Hub, comme indiqué ci-dessus
...
----
--
. Ajoutez l'autorisation de lecture pour accéder à l'API kubernetes et aux RBAC d'OpenShift. 
+
[IMPORTANT]
====
...
S'il y a des taints supplémentaires comme ci-dessus, ajoutez-les à la section des tolérances yaml d'exemple :
