...
* {product-name} est compatible avec la plupart des CNI commercialement pris en charge. Les tests et le support officiels concernent openshift ovs (sous-réseau/multitenant), calico, flannel, cilium, antrea et les clouds publics (gke, aks, iks, eks). Le support pour Multus a été ajouté dans v5.4.0.
