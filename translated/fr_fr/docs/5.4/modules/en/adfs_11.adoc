...
. Cochez &quot;`+Enable support for the SAML 2.0 WebSSO protocol+`&quot; et entrez l'URI de redirection SAML depuis la page Paramètres > Paramètres SAML dans le champ &quot;`+Relying party SAML 2.0 SSO service URL+`&quot;.  Sélectionnez &quot;`+Next+`&quot; pour continuer.
+
