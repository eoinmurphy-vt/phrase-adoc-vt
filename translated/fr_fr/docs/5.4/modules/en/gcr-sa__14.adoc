...
Avant de vous exciter trop, il y a une chose de plus à assurer. Pour que le scanner dans {product-name} utilise l'API pour scanner et protéger vos images, cette API doit être activée dans votre compte GCP. Vous pouvez soit l'activer via la ligne de commande via
