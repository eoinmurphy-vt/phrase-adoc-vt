...
* (Icône de Service Mesh) Double-cliquez pour développer un pod dans un service mesh tel qu'Istio/Linkerd2 pour montrer le sidecar et les conteneurs de charge de travail dans le pod.
