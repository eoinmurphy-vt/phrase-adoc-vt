...
[IMPORTANT]
====
L'URL pour la commande `+curl+` dépend de la manière dont les services `+fed-master+` sont exposés. Si un service `+ingress+` est configuré, il n'est pas nécessaire de spécifier un port.
====
...
[IMPORTANT]
====
L'URL pour la commande `+curl+` dépend de la manière dont les services `+fed-managed+` sont exposés. Si un service `+ingress+` est configuré, il n'est pas nécessaire de spécifier un port.
====
