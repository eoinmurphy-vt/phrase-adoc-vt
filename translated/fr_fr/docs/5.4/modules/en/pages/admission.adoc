...
Dans la {product-name} Console dans la Politique -> Contrôle d'Admission, allez à Plus d'Opérations -> Paramètre Avancé et cliquez sur le bouton "Tester". {product-name} modifiera le service neuvector-svc-admission-webhook et vérifiera si notre serveur webhook peut recevoir la notification de changement ou s'il échoue.
