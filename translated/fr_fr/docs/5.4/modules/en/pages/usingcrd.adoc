...
[NOTE]
====
En plus des groupes sélectionnés, tous les groupes 'liés' seront également exportés. Un groupe lié est tout autre groupe auquel un groupe sélectionné se connectera ou d'où il se connectera, comme le permet une règle de réseau.
====
...
* Ceci est un CRD de type espace de noms, de NvSecurityRule
...
== Groupes de politiques et support de migration des règles
