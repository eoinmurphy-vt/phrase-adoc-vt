...
Chaque pod de scanner interrogera les registres à scanner pour récupérer la liste complète des images disponibles et d'autres données. Chaque scanner se verra ensuite attribuer une image à récupérer et à scanner depuis le registre.
