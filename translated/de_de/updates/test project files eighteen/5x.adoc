...
* **NVSHAS-9909**: "Abgemeldet - Gehe zur Lade-Seite" Nachricht wird angezeigt, wenn der NeuVector Rancher NavLink verwendet wird.
...
* **NVSHAS-9480**: Die NV UI, die im Rancher-Downstream-Cluster bereitgestellt wird, gibt nach dem Ausloggen von Rancher einen HTTP/403-Fehler aus.
...
* **NVSHAS-8799**: Erstellen Sie ein Compliance-Rahmenwerk zum Importieren von Compliance-Vorlagen.
...
* **NVSHAS-9238**: Die UI aktualisiert den angezeigten Clusternamen nicht, nachdem er geändert wurde.
...
* **NVSHAS-9121**: Die Netzwerkwachschwellenwerteinstellung der Gruppe kann nicht bearbeitet werden.
...
* Erlauben Sie bei der Konfiguration eines Registrys, ob der definierte Proxy für die Scans von Registrierungsbildern verwendet werden soll.
...
* Exportieren / Importieren des Schwachstellenprofils über Konsole, CRD oder REST-API. Das Importieren ersetzt das vorhandene Profil. Das Löschen der CRD führt zu einem leeren Profil.
* Exportieren / Importieren der Compliance-Profilvorlage über Konsole, CRD oder REST-API. Das Importieren ersetzt die vorhandene Vorlage.
...
* Der erweiterte Bericht über Schwachstellen zeigt Bilder aus allen anderen Namespaces an.
...
* Fügen Sie Enforcer-Umgebungsvariablen zum Deaktivieren des Scannens von Geheimnissen und zum Ausführen von CIS-Benchmarks hinzu
