...
{product-name} unterstützt auch Antwortregeln, um häufige Antworten auf Sicherheitsereignisse oder erkannte Schwachstellen zu automatisieren. Bitte sehen Sie sich den Abschnitt Sicherheitsrichtlinie -> Antwortregeln für weitere Details an.
...
=== Test_TwoErstelle Richtlinienregeln automatisch
