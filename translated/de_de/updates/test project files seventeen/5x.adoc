= Testprojekt siebzehn 5.x Versionshinweise
:revdate: 2025-08-26
...
* *NVSHAS-9934*: Verdächtige Nulldrift-Funktionalität funktioniert nicht.
...
* **NVSHAS-9189**: Der Scan bleibt beim Planen hängen, nachdem der Controller heruntergefahren und neu gestartet wurde.
...
* **NVSHAS-9290**: Benutzerhinzugefügte Prozessprofilregel hat keine Wirkung, wenn ZD aktiviert ist.
...
* Die Versionierung des Prometheus-Exporters wurde überprüft und von der `+controller+` Versionierung dissociiert.
...
* Fügen Sie einen neuen Regex-Operator in Richtlinie > Zugangssteuerung > Regel hinzufügen für Benutzer und Benutzergruppen hinzu, um Regex zu unterstützen. Unterstützung der Operatoren "entspricht IRGENDEINEM Regex in" und "entspricht KEINEM Regex in".
...
* Der aktuelle OpenShift-Operator unterstützt Passthrough-Routen für API- und Föderationsdienste. Zusätzliche Helm-Wertparameter wurden hinzugefügt, um Edge- und Re-Encrypt-Routenbeendigungstypen zu unterstützen.
