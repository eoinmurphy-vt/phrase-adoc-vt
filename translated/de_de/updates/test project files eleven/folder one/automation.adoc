= Test_ElevenREST API und Automatisierung
:revdate: 2025-05-08
...
* Zulassungsrichtlinien zur Genehmigung/Verweigerung unautorisierter Bereitstellungen
...
[NOTE]
====
Wenn Sie den Typ LoadBalancer verwenden, setzen Sie die _controllerIP_ in den folgenden Beispielen auf die externe IP oder URL für den Lastenausgleich.
====
...
=== Test_ZweiErstelle Richtlinienregeln automatisch
...
=== Test_TwoAktivieren Sie die Containerquarantäne deaktivieren
