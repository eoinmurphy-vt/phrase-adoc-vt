= Testprojekt sechzehn REST API und Automatisierung
:revdate: 2025-05-08
...
* Zulassungssteuerungsrichtlinien zur Erlauben/Verweigern unautorisierter Bereitstellungen
...
=== Test_ZweiVerwalten Sie die Föderation für Master- und Remote- (Arbeiter-) Cluster
