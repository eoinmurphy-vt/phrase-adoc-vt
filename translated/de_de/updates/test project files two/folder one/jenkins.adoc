...
=== Test_TwoJenkins Plugin-Installation
...
=== Test_TwoGlobal-Konfiguration in Jenkins
...
=== Test_TwoLocal Konfiguration zum Scannen eines Remote-Docker-Hosts

==== Test_TwoVoraussetzungen für den lokalen Scan auf einem Remote-Docker-Host
...
=== Test_TwoAdditional Stages

Fügen Sie Ihre eigenen Vor- und Nachbild-Scan-Stufen hinzu, zum Beispiel im Beispiel der Pipeline-Stufenansicht unten.
...
=== Test_ZweiEinrichten der Pipeline für große parallele Scans
...
== Test_ZweiOpenShift-Routen- und Registry-Token-Beispiel
...
== Test_ZweiBesonderer Anwendungsfall für Jenkins im selben Kubernetes-Cluster
