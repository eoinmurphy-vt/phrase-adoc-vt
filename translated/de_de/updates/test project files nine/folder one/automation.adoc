= Test_TwoREST API und Automatisierung
:revdate: 2025-05-08
...
Stellen Sie sicher, dass Sie die IP-Adresse des Controllers im Skript eingeben und den Namen des Container-Images in das gewünschte Bild ändern, das Sie scannen möchten. Aktualisieren Sie auch die Felder für Benutzername/Passwort.
...
=== Test_TwoStarten der Paketaufzeichnung auf einem Container
