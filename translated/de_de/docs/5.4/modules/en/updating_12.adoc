...
Die Version der CVE-Datenbank kann in der Konsole im Tab 'Vulnerabilities' gesehen werden. Sie können auch das Updater-Containerbild inspizieren. Die neueste Versionsnummer der Datenbank kann auch https://raw.githubusercontent.com/neuvector/manifests/main/versions/scanner[hier] aufgeführt gefunden werden.
...
Upgrade zuerst auf eine 5.1.x-Version wie 5.1.3, dann siehe den Abschnitt xref:kubernetes.adoc[Kubernetes-Bereitstellung] für das Upgrade auf 5.2.x+ für wichtige Änderungen an Dienstkonten und Bindungen.
