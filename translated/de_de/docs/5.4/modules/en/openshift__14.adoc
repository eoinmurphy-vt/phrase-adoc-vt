...
Um zu verhindern, dass der Durchsetzer auf einem Controller-Knoten bereitgestellt wird, wenn es sich um einen dedizierten Verwaltungs-Knoten (ohne zu überwachende Anwendungscontainer) handelt, fügen Sie eine nodeAffinity zum Enforcer yaml Abschnitt hinzu. Zum Beispiel:
