...
NeuVector v5.4.0 unterstützt die Automatisierung der Föderation über die ConfigMap. Unten sind Beispielkonfigurationen `+fedinitcfg.yaml+`, die je nach Anwendungsfall auf Ihre primären und verwalteten Cluster angewendet werden können.
