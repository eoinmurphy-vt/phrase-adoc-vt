...
Nachdem Sie die {product-name} Komponenten bereitgestellt haben, können Sie diese mit den bereitgestellten Beispiel-Testanwendungen bewerten. Diese befinden sich im `+'nvbeta+`' Repository auf Docker Hub.
