...
{product-name} enthält standardmäßige selbstsignierte Zertifikate zur Verschlüsselung für die Verwaltung (Konsolen-/UI-Zugriff), Controller (REST-API, intern), Durchsetzer (intern) und Scanner (intern) Kommunikation.
