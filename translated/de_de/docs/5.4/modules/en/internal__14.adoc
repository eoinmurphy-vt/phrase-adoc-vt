...
{product-name} enthält standardmäßige selbstsignierte Zertifikate zur Verschlüsselung für die Verwaltung (Konsole/UI-Zugriff), Controller (REST-API, intern), Enforcer (intern) und Scanner (intern) Kommunikationen.
