...
Bitte siehe den Abschnitt xref:users.adoc#_mapping_groups_to_roles_and_namespaces[Benutzer und Rollen] für Informationen zur Zuordnung von Gruppen zu vordefinierten und benutzerdefinierten Rollen sowie Namespaces in {product-name}.
