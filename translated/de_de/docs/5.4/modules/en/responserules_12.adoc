...
[IMPORTANT]
====
Alle Antwortregeln werden ausgewertet, um zu bestimmen, ob sie der Bedingung/Kriterium entsprechen. Wenn mehrere Regeln übereinstimmen, werden die jeweiligen Aktionen ausgeführt. Dies unterscheidet sich vom Verhalten der Netzwerkregeln, die von oben nach unten ausgewertet werden und nur die erste übereinstimmende Regel ausgeführt wird.
====
