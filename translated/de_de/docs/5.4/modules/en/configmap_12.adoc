...
Das Backup der Konfiguration des persistenten Speichers wird zuerst gelesen, dann werden die ConfigMaps angewendet, sodass die Einstellungen des ConfigMaps Vorrang haben. Alle Einstellungen des ConfigMap (z. B. Updates) werden ebenfalls im persistenten Speicher gespeichert.
