...
* Zulassungsrichtlinien zur Erlaubnis/Verweigerung unautorisierter Bereitstellungen
...
Holen Sie sich das Authentifizierungstoken wie oben. Ersetzen Sie auch die Controller-IP-Adresse durch Ihre, wie erforderlich.
