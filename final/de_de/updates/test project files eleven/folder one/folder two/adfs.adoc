...
. Klicken Sie im AD FS-Management mit der rechten Maustaste auf "`Vertrauensstellung für vertrauende Parteien`" und wählen Sie "`Vertrauensstellung für vertrauende Partei hinzufügen...`".
+
