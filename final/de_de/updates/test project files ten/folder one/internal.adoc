= Test_ZehnErsetzen interner Zertifikate
:revdate: 2025-01-27
...
{product-name} enthält standardmäßige selbstsignierte Zertifikate zur Verschlüsselung für die Verwaltung (Konsole/UI-Zugriff), Controller (REST-API, intern), Durchsetzer (intern) und Scanner (intern) Kommunikation.
...
+
* Danach befolgen Sie die Schritte im `Regenerate certificate files and add SANs` Tab und migrieren Sie zu Ihrem eigenen Zertifikat.
