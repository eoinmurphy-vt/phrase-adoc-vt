= Testprojekt siebzehn OpenID Connect Azure/Okta
:revdate: 2024-09-27
...
Ein abgeleitetes Fenster erscheint zur Auswahl des "`Anwendungstyps`":
...
Gehen Sie auf Ihrer Anwendungsintegrationsseite zum Tab "`Zuweisungen`" und stellen Sie sicher, dass die entsprechenden Zuweisungen aufgelistet sind:
