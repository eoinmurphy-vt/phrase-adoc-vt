= Testprojekt siebzehn REST API und Automatisierung
:revdate: 2025-05-08
...
{product-name} unterstützt auch Antwortregeln, um häufige Antworten auf Sicherheitsereignisse oder erkannte Schwachstellen zu automatisieren. Bitte sehen Sie den Abschnitt Sicherheitsrichtlinie -> Antwortregeln für weitere Details an.
...
=== Test_TwoBerichten Sie, ob eine Schwachstelle in den Basisbildschichten vorhanden ist
