...
Beispiel - größte Bildgröße = Test_Five1.3GB, der Speicher des Scanner-Containers sollte 1,8 GB betragen.
...
== Test_FiveUnterstützte Plattformen
...
== Test_FivePerformance und Skalierung
...
=== Test_FiveHinzufügen von Skalierungsbeschränkungen für große Arbeitslastumgebungen
