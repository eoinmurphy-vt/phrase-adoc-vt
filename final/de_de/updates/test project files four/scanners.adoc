= Test_FünfParallel & Standalone Scanner
:revdate: 2024-09-27
:page-revdate: {revdate}
:page-opendocs-origin: /06.scanning/06.scanners/06.scanners.md
:page-opendocs-slug:  /scanning/scanner

== Test_FünfErhöhung der Scanner-Skalierbarkeit mit mehreren Scannern
...
=== Test_FünfAuto-Skalierung von Scanner-Pods
...
=== Test_FünfOperationen und Debugging
...
== Test_FiveStandalone Scanner für lokale Scans
...
* SCANNER_REGISTRY= Test_FiveURL des Registrys (optional anstelle des lokalen Scans)
* SCANNER_REPOSITORY= Test_FiveRepository zum Scannen
* SCANNER_TAG= Test_FiveVersions-Tag
* SCANNER_REGISTRY_USERNAME= Test_FiveBenutzer (optional anstelle des lokalen Scans)
* SCANNER_REGISTRY_PASSWORD= Test_FivePasswort (optional anstelle des lokalen Scans)
* SCANNER_SCAN_LAYERS= Test_Fivewahr oder falsch (um geschichtete Scannergebnisse zurückzugeben)
...
* CLUSTER_ADVERTISED_ADDR (optional) - wenn der Scanner auf einem anderen Host als dem Controller ist, um Ergebnisse für die Verwendung in Admission-Control-Regeln (Kubernetes-deployter Controller) zu senden.

=== Test_FiveHost Scannen im Standalone-Modus
...
=== Test_FiveManual Bereitstellung mehrerer Scanner auf Kubernetes
