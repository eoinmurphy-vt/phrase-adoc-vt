= Test_SixDeploy Verwendung von Operatoren
:revdate: 2025-06-02
...
== Test_Six\{product-name} Operatoren
...
* Stellen Sie sicher, dass der Registrierungs-Pfad und der Versions-Tag korrekt gesetzt sind (Community-Operator; zertifiziert verwendet die Standardwerte)
