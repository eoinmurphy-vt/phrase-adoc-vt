...
** Suchen Sie nach \{product-name} Operator und wählen Sie die Liste ohne Community- oder Marktplatzabzeichen aus 
...
** Navigieren Sie in der OpenShift Console UI zu OperatorHub 
** Suchen Sie nach dem \{product-name} Operator und wählen Sie das Listing mit dem Community-Abzeichen aus 
** Klicken Sie auf Installieren 
