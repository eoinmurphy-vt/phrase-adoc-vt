...
Bien que l'interface de ligne de commande soit disponible via le Manager, nous recommandons d'utiliser directement l'xref:automation.adoc[API REST] dans le contrôleur pour les requêtes et l'automatisation.
