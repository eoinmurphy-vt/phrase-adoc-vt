...
Les fournisseurs de cloud public prennent en charge la capacité d'auto-scaler les nœuds, ce qui peut évincer dynamiquement des pods, y compris les {product-name} contrôleurs. Pour éviter les interruptions des contrôleurs, un budget de perturbation de pod {product-name} peut être créé.
