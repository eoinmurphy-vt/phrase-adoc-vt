...
La valeur des minutes de délai d'attente terminera l'étape de construction dans le temps saisi. La valeur par défaut de 0 signifie qu'aucun délai d'attente ne se produira.
