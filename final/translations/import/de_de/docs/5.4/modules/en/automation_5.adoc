...
Stellen Sie sicher, dass Sie die IP-Adresse des Controllers im Skript eingeben und den Containerbildnamen in den Namen ändern, den Sie scannen möchten. Aktualisieren Sie auch die Felder für Benutzername/Passwort.
