...
* **NVSHAS-9128**: Sicherheitsereignisse: Container können nicht angezeigt werden, wenn kein Namespace-Wert der Arbeitslast vorhanden ist.
 ...
 ** Die Verwendung von benutzerdefinierten Zertifikaten wird wie zuvor sowohl für Helm- als auch für yaml-basierte Bereitstellungen unterstützt.
...
* Automatische Scan-Aktivierung und Löschung von nicht verwendeten Gruppenalter zu configMap hinzufügen.
...
Optional können Sie alle Verweise auf die {product-name} Lizenz und das Registry-Geheimnis in Helm-Charts, Bereitstellungs-YAML, ConfigMap, Skripten usw. entfernen, da diese nicht mehr erforderlich sind, um die Bilder abzurufen oder {product-name} zu verwenden.
...
* Unterstützung für OWASP Top-10, WAF-ähnliche Regeln zur Erkennung von Netzwerkangriffen in Headern oder im Body hinzufügen. Beinhaltet Unterstützung für CRD-Definitionen von Signaturen und Anwendung auf die entsprechenden Gruppen.
