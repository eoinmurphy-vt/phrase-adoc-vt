= Notes de version de Test projet dix-sept 5.x
:revdate: 2025-08-26
...
* *NVSHAS-9787*: Supprimer le journal de gestion inutile.
* *NVSHAS-9788*: Affiner l'algorithme pour générer le certificat.
* *NVSHAS-9789*: Supprimer le journal de gestion inutile sur la configuration du registre distant.
...
* *NVSHAS-9953*: Les Pods Enforcer redémarrent sans cesse.
...
* **NVSHAS-7687**: Prise en charge de la configuration du niveau de journalisation (déboguer/erreur/info/avertir) pour l'enforcer et le contrôleur depuis l'interface de ligne de commande.
...
* Correction d'un problème où l'URL de l'émetteur OpenID regex échouait.
...
* Lors de la mise à niveau depuis {product-name} version 4.x, une appartenance incorrecte au groupe de pods entraîne une violation de politique inattendue
...
. Mettez à jour les noms et chemins d'image pour tirer {product-name} des images de Docker hub (docker.io), par exemple.
