= Tester le projet seize API REST et automatisation
:revdate: 2025-05-08
...
* Diagramme Helm sur github pour le déploiement automatisé sur Kubernetes
...
=== Test_TwoExport/Importer le fichier de configuration
...
=== Test_TwoParamétrer ou changer le mot de passe de l'utilisateur
...
Lorsqu'un container présente un comportement suspect, démarrez une capture de paquets.
...
=== Test_TwoActiver le mode débogage pour le support {product-name}
