= Test_CinqDéployer en utilisant des opérateurs
:revdate: 2025-06-02
...
[IMPORTANT]
====
Les versions d'opérateur certifiées \{nom-du-produit} sont liées aux versions de produit \{nom-du-produit}, et chaque nouvelle version doit passer par un processus de certification avec Red Hat avant d'être publiée. La version d'opérateur certifiée pour 5.3.x est liée à la version helm 2.7.2 et à la version de l'application \{nom-du-produit} 5.3.2. La version d'opérateur certifiée 1.3.9 est liée à la version \{nom-du-produit} 5.2.0. La version d'opérateur certifiée 1.3.7 est liée à la version \{nom-du-produit} 5.1.0. La version 1.3.4 de l'opérateur est liée à \{product-name} 5.0.0. Si vous souhaitez pouvoir changer les balises de version des conteneurs \{product-name} déployés, veuillez utiliser la version Community.
====
...
** Recherchez l'opérateur \{product-name} et sélectionnez l'annonce sans badge de communauté ou de marché 
