...
. Depuis les services ECS, éteignez et mettez à jour les Enforcers. Tirez manuellement ou déclenchez automatiquement le tirage de nouvelles images d'Enforcer. Puis redémarrez ou mettez à jour l'Enforcer sur tous les nœuds. Depuis la console {product-name}, vous verrez que tous les Enforcers sont à jour.
