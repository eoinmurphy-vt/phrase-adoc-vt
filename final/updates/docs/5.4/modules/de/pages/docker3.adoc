...
Wo s1 Scanner 1 ist (verwenden Sie s2, s3 usw. für jeden zusätzlichen Scanner).
...
Die obige Syntax gilt für Docker EE v17.06.0+. Versionen vor dieser verwenden das : anstelle von =, zum Beispiel apparmor:unconfined.
