...
:revdate: 25-0125-010924-09010924-09090-0909
...
Die wichtigste Umgebungsvariable ist *CLUSTER_JOIN_ADDR*. Für Durchsetzer ersetzen Sie `<controller_node_ip>` durch die IP-Adresse des Controllers. Typischerweise haben *CLUSTER_JOIN_ADDR* in der docker-compose-Datei des Controllers/All-in-One und in der docker-compose-Datei des Durchsetzers denselben Wert.
