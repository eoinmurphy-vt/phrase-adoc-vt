...
NeuVector v5.4.0 unterstützt Federation-Automatisierung durch die ConfigMap. Im Folgenden finden Sie Beispielkonfigurationen für `fedinitcfg.yaml`, die je nach Anwendungsfall auf Ihre primären und verwalteten Cluster angewendet werden können.
