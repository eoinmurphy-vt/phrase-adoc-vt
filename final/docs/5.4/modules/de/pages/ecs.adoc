...
. Setzen Sie in den ECS-Diensten den alten Allinone/Controller-Dienst zurück und löschen Sie ihn. Ziehen Sie die aktualisierten {product-name} Bilder manuell oder lösen Sie AWS ECS aus, um neue Versionen von Allinone/Controller-Containern von Dockerhub oder Ihrem privaten Repository abzurufen.
