...
{product-name} kann konfiguriert werden, um nach Schwachstellen zu suchen, die in der Gitlab-Bau-Pipeline ausgelöst werden. Es gibt ein https://gitlab.com/neuvector/gitlab-plugin[Gitlab-Plugin hier], das konfiguriert und verwendet werden kann. Bitte folgen Sie den Anweisungen auf der Gitlab-Website zur Verwendung des Plugins.
