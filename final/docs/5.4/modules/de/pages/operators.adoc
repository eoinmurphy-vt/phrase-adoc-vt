...
** Suchen Sie nach {product-name} Betreiber und wählen Sie die Auflistung ohne Community- oder Marktplatz-Abzeichen aus 
...
** Spezifischen Namensraum im Cluster auswählen 
...
** Navigieren Sie in der OpenShift-Konsole zur OperatorHub 
** Suchen Sie nach {product-name} Operator und wählen Sie die Liste mit dem Community-Abzeichen aus 
** Klicken Sie auf Installieren 
