...
Sie werden jetzt ein {product-name} Menüelement auf der linken Seite sehen, und die Auswahl davon zeigt eine {product-name} Kachel/Schaltfläche, die, wenn sie angeklickt wird, Sie zur {product-name} Konsole in einem neuen Tab bringt.
