...
+
____
(Optionnel) Entrez un numéro. Les règles de réseau sont initialement ordonnées de la plus basse à la plus haute, mais l'ordre des règles peut être changé en les faisant glisser et en les déposant dans la liste.
____
...
=== Politique IP Ingress basée sur X-FORWARDED-FOR
