...
Vous verrez maintenant un élément de menu {product-name} à gauche, et en le sélectionnant, vous verrez une tuile/bouton {product-name}, qui, lorsqu'il est cliqué, vous amènera à la console {product-name}, dans un nouvel onglet.
