...
Les conteneurs avec un cercle rouge autour d'eux ont été mis en quarantaine. Pour déquarantiner, faites un clic droit sur le conteneur et sélectionnez le bouton de déquarantaine.
