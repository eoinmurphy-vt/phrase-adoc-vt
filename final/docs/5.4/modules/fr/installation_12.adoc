...
Ce volume peut être mappé à xref:production.adoc#_backups_and_persistent_data[stockage persistant] pour maintenir la configuration. Les fichiers dans le dossier peuvent devoir être supprimés afin de repartir à zéro.
